...
describe('ColeccionCartas', () => {
  ...
  it('should list cartas from user collection', (done) => {
    ...
    coleccion.addCarta('user2', carta1, (error, _) => {
      coleccion.addCarta('user2', carta2, (error, _) => {
  ...
  it('should remove a carta from user collection', (done) => {
    ...
    coleccion.addCarta('user5', carta, (error, _) => {
      coleccion.removeCarta('user5', 1, (_, resultado) => {
        expect(resultado).to.equal(`Card with id 1 removed from user5 collection!`);
  ...
  it('should list cartas from user collection with all colors', (done) => {
    coleccion.removeCarta('user', 1, (error, _) => {
      ...
      coleccion.addCarta('user', carta1, (error, _) => {
        coleccion.addCarta('user', carta2, (error, _) => {
          coleccion.addCarta('user', carta3, (error, _) => {
            coleccion.addCarta('user', carta4, (error, _) => {
              coleccion.addCarta('user', carta5, (error, _) => {
                coleccion.addCarta('user', carta6, (error, _) => {
                  coleccion.addCarta('user', carta7, (error, _) => {
